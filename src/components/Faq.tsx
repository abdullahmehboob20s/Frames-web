...
function Faq() {
  return (
    <div className="sm:container">
      <div className="bg-darkBlack pb-[40px] sm:pb-[50px] lg:pb-0 py-[24px] sm:py-[40px] lg:py-[100px] px-[24px] sm:px-[40px] lg:px-[150px] border-2 border-mahron sm:rounded-[34px]">
